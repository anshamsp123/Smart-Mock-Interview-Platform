...
The system leverages **Natural Language Processing (NLP)**, **computer vision concepts**, **sentiment analysis**, and **data visualization**, accelerated by **Groq AI’s low-latency inference**, to evaluate user responses and deliver actionable insights in near real-time.
...
Transformer-based language models (BERT/RoBERTa – conceptual)  
